...
export default function Contact() {
  ...
  return (
    <section id="contato" className="relative md:min-h-dvh flex flex-col pt-[120px] pb-[80px] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/4 w-52 h-52 md:w-80 md:h-80 bg-blue-500/5 dark:bg-blue-500/8 rounded-full blur-2xl md:blur-3xl pointer-events-none" />
